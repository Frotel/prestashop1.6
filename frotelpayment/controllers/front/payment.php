...
class FrotelPaymentPaymentModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		if($newCookie->__get("error_message") != "")
			$err = 1;
		else
			$err = 0;
		...
		$this->context->smarty->assign(array(
			...
			'haserror' => $err,
			'error' => $newCookie->__get("error_message")
		));
		
		$newCookie->__unset("error_message");
