...
class MyModPaymentBankModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		if(isset($_GET["status"]) && $_GET["status"] == "continuepay")
		{
				...
				{
					Tools::redirect($this->context->link->getModuleLink('mymodpayment', 'banks')."?status=orderpay");
				}
